...
//             CommandType.startRecording.stringValue,
//           );
//           break;
...
//         case ClientType.androidCamera:
//           await _sendMessageToInterface(
//             CommandType.stopRecording.stringValue,
//           );
//           Future.delayed(const Duration(seconds: 2)).then((_) {
//             _sendMessageToInterface(
//               '${CommandType.rfId.stringValue}:'
...
//   await _sendMessage(id, '${CommandType.token.stringValue}:$token');
// }
